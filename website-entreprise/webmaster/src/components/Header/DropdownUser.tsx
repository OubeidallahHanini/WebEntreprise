    ...
    <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
      ...
      >
        ...
        <span className="h-12 w-12 rounded-full">
          <img src={`http://localhost:3005/uploads/${user.photo}`} alt="User" />
        </span>
      ...
      className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            ...
            <li>
              <Link
                to={`/account-settings/${user.userID}`}
                className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
              >
                <svg
                  className="fill-current"
          ...
          >
            ...
            >
              <path
                d="M17.0188 0.753809H6.6393C5.07118 0.753809 3.80304 1.98881 3.80304 3.55416V8.15944C3.80304 8.60632 4.14679 8.95006 4.59366 8.95006C5.04054 8.95006 5.38429 8.60632 5.38429 8.15944V3.55416C5.38429 2.77168 6.01081 2.14516 6.79329 2.14516H17.0188C17.8013 2.14516 18.4278 2.77168 18.4278 3.55416V18.4458C18.4278 19.2283 17.8013 19.8548 17.0188 19.8548H6.79329C6.01081 19.8548 5.38429 19.2283 5.38429 18.4458V13.8406C5.38429 13.3937 5.04054 13.05 4.59366 13.05C4.14679 13.05 3.80304 13.3937 3.80304 13.8406V18.4458C3.80304 20.0112 5.07118 21.2462 6.6393 21.2462H17.0188C18.5877 21.2462 19.8465 20.0112 19.8465 18.4458V3.55416C19.8465 1.98881 18.5877 0.753809 17.0188 0.753809Z"
                fill=""
              />
              <path
                d="M13.5195 11.1062C13.8124 11.3991 14.2873 11.3991 14.5802 11.1062L17.5802 8.10624C17.873 7.81335 17.873 7.33847 17.5802 7.04558L14.5802 4.04558C14.2873 3.75269 13.8124 3.75269 13.5195 4.04558C13.2266 4.33847 13.2266 4.81335 13.5195 5.10624L15.3992 6.98599H8.92154C8.47466 6.98599 8.13091 7.32974 8.13091 7.77662C8.13091 8.22349 8.47466 8.56724 8.92154 8.56724H15.3992L13.5195 10.447C13.2396 10.7133 13.2396 11.2008 13.5195 11.1062Z"
                fill=""
              />
            </svg>
            Log out
